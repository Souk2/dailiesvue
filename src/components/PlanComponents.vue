      ...
      <!-- Small boxes (Stat box) -->
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="d-flex justify-content-between">
              <RouterLink to="/plansuccess" class="btn btn-primary btn-sm"><i class="fas fa-arrow-circle-right mr-1"></i><b>ແຜນການທິ່ສຳເລັດແລ້ວ</b></RouterLink>
              <RouterLink to="/plannotsuccess" class="btn btn-danger btn-sm"><i class="fas fa-arrow-circle-right mr-1"></i><b>ແຜນການທິ່ຍັງບໍ່ສຳເລັດ</b></RouterLink>
            </div>
            <div class="overflow-auto">
              ...
              <tbody>
                ...
                <tr v-else v-for="(plan, index) in plans" :key="plan.id">
                  ...
                  <td>
                    <button @click="ShowPlansItem(plan.id)" class="btn btn-warning" data-toggle="modal" data-target="#modal-info"><i class="fas fa-edit"></i></button>
...
export default {
  name: 'PlanComponents', // sone ti hai runter hu
  ...
  methods:{
    ...
    async CreatePlan(){
      try{
        ...
        this.ResetPlans_Form();
      }catch (error){
        console.error('Error create Plans',error);
        this.ShowErrorMessage();
      }
   },

    // Function Reset Plans Form

    async ResetPlans_Form(){
      this.name = "",
      this.percent = ""
    },
