        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Table (ຕາຕະລາງ)</li>
            </ol>
          </div><!-- /.col -->
        </div>
        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex">
                                    <select name="" id="" v-model="searchQuerydays" required class="form-control">
                                        <option value="ວັນຈັນ">ວັນຈັນ</option>
                                        <option value="ວັນອັງຄານ">ວັນອັງຄານ</option>
                                        <option value="ວັນພຸດ">ວັນພຸດ</option>
                                        <option value="ວັນພະຫັດ">ວັນພະຫັດ</option>
                                        <option value="ວັນສຸກ">ວັນສຸກ</option>
                                    </select>
                                    <button @click="SearchSchoolTables" class="btn btn-primary ml-2"><i
  ...
  <section class="content">
    <div class="container-fluid">
                    ...
                    <table class="table table-striped border overflow-auto">
                        ...
                        <tbody>
                            <tr v-if="none_data">
                                ...
                                <td>
                                    <button @click="ShowSchoolTableItem(school_table.id)" class="btn btn-warning" data-toggle="modal" data-target="#modal-info"><i class="fas fa-edit"></i></button>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content ">
            <div class="modal-header bg-info">
              <h4 class="modal-title">ຟອມແກ້ໄຂຂໍ້ມູນການບັນທຶກ</h4>
            ...
            <form enctype="multipart/form-data" @submit.prevent="UpdateSchoolTable">
              <div class="modal-body">
                <div class="row">
                    ...
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 1: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="updatefirst_time" required placeholder="ຊົ່ວໂມງທີ 1">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 2: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="updatesecond_time" required placeholder="ຊົ່ວໂມງທີ 2">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 3: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="updatethird_time" required placeholder="ຊົ່ວໂມງທີ 3">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 4: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="updatefourth_time" required placeholder="ຊົ່ວໂມງທີ 4">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ວັນ: <span class="text-danger">*</span></label>
                    <select name="" id="" v-model="updatedays" required placeholder="ວັນ" class="form-control">
                        <option value="ວັນຈັນ">ວັນຈັນ</option>
                        <option value="ວັນອັງຄານ">ວັນອັງຄານ</option>
                        <option value="ວັນພຸດ">ວັນພຸດ</option>
                        <option value="ວັນພະຫັດ">ວັນພະຫັດ</option>
                  ...
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຕັ້ງແຕ່ວັນທີ: <span class="text-danger">*</span></label>
                    <input type="date" class="form-control" v-model="updatesince_date" required placeholder="ຕັ້ງແຕ່ວັນທີ">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຈົນເຖິງວັນທີ: <span class="text-danger">*</span></label>
                    <input type="date" class="form-control" v-model="updateuntil_date" required placeholder="ຈົນເຖິງວັນທີ">
                  </div>
                </div>
            </div>
            ...
            <form enctype="multipart/form-data" @submit.prevent="CreateSchoolTable">
              <div class="modal-body">
                <div class="row">
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 1: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="first_time" required placeholder="ຊົ່ວໂມງທີ 1">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 2: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="second_time" required placeholder="ຊົ່ວໂມງທີ 2">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 3: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="third_time" required placeholder="ຊົ່ວໂມງທີ 3">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊົ່ວໂມງທີ 4: <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" v-model="fourth_time" required placeholder="ຊົ່ວໂມງທີ 4">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ວັນ: <span class="text-danger">*</span></label>
                    <select name="" id="" v-model="days" required placeholder="ວັນ" class="form-control">
                        <option value="ວັນຈັນ">ວັນຈັນ</option>
                        <option value="ວັນອັງຄານ">ວັນອັງຄານ</option>
                        <option value="ວັນພຸດ">ວັນພຸດ</option>
                        <option value="ວັນພະຫັດ">ວັນພະຫັດ</option>
                  ...
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຕັ້ງແຕ່ວັນທີ: <span class="text-danger">*</span></label>
                    <input type="date" class="form-control" v-model="since_date" required placeholder="ຕັ້ງແຕ່ວັນທີ">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຈົນເຖິງວັນທີ: <span class="text-danger">*</span></label>
                    <input type="date" class="form-control" v-model="until_date" required placeholder="ຈົນເຖິງວັນທີ">
                  </div>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
      ...
      <div class="row mt-3 mb-3">
        <div class="col-md-6 col-sm-3 col-lg-4 col-xl-3">
...
<script>
    ...
    export default {
        ...
        created(){
            this.ShowSchoolTables();
        },
        methods:{

            //Function Search Module
            async ShowSchoolTables(){
                try{
            ...
            async CreateSchoolTable(){
                try{
                    ...
                    console.error('Error create School Table',error);
                    this.ShowErrorMessage();
                }
            },

            //Function Reset Note Form
            ...
            async ConfirmDelete(Table_ID){
                Swal.fire({
                    ...
                    text: 'ທ່ານແນ່ໃຈບໍ ທີຈະລົບລະຫັດທີ່:'+ Table_ID,
                    icon: 'warning',
            ...
            async ShowSchoolTableItem(Table_ID){
                ...
                try{
                    ...
                    this.updatefirst_time = response.data.first_time,
                    this.updatesecond_time = response.data.second_time,
                    this.updatethird_time = response.data.third_time,
                    this.updatefourth_time = response.data.fourth_time,
                    this.updatedays = response.data.days,
                    this.updatesince_date = response.data.since_date,
                    this.updateuntil_date = response.data.until_date
                }catch(error){
            ...
            async UpdateSchoolTable(){
                try{
                    ...
                    first_time : this.updatefirst_time,
                    second_time : this.updatesecond_time,
                    third_time : this.updatethird_time,
                    fourth_time : this.updatefourth_time,
                    days : this.updatedays,
                    since_date : this.updatesince_date,
                    until_date : this.updateuntil_date,
                    });
                    console.log(response.data);
