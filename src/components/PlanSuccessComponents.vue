      ...
      <!-- Small boxes (Stat box) -->
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <h3 class="text-center text-primary"><b>ລາຍຊື່ແຜນການສຳເລັດແລ້ວ</b></h3>
            <div class="overflow-auto">
              ...
              <tbody>
                ...
                <tr v-else v-for="(plan, index) in plans" :key="plan.id">
                  ...
                  <td>
                    <button @click="ShowPlanSuccesssItem(plan.id)" class="btn btn-warning" data-toggle="modal" data-target="#modal-info"><i class="fas fa-edit"></i></button>
...
export default {
  name: 'PlanSuccessComponents', // sone ti hai runter hu
  ...
  created(){
    this.ShowPlanSuccesss();
  },
  methods:{

    //Function Search Plans
    async ShowPlanSuccesss(){
      try{
    ...
    async ShowPlanSuccesssItem(Plan_ID){
