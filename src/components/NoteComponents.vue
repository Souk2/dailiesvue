        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Note (ບັນທຶກ)</li>
            </ol>
          </div><!-- /.col -->
        </div>
        <div class="row mb-2">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="d-flex">
                  ...
                  <button @click="SearchNoteByModule" class="btn btn-success ml-2"><i class="fas fa-search"></i></button>
                </div>
              </div>
              <div class="col-md-6">
                <div class="d-flex">
                  <input type="search" required v-model="searchQuery" class="form-control" placeholder="ຊອກຫາ...">
                  <button @click="SearchNote" class="btn btn-success ml-2"><i class="fas fa-search"></i></button>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Small boxes (Stat box) -->
        <div class="row">
              ...
              <form @submit.prevent="CreateNote">
                <div class="card-body">
                  <div class="row">
                    ...
                    <label for="exampleInputEmail1">ເນື້ອໃນ: <span class="text-danger">*</span></label>
                    <textarea name="" id="" cols="30" v-model="content" rows="10" class="form-control" placeholder="ເນື້ອໃນ"></textarea>
                  </div>
                   <div class="form-group ml-2 mb-3">
                    <label for="">ໂມດຸນ:<span class="text-danger">*</span></label>
          ...
          <div class="col-md-6">
            ...
            <h3 class="text-center text-success"><b>ລາຍຊື່ການບັນທຶກ</b></h3>
            <div class="overflow-auto">
              ...
              <tbody>
                ...
                <tr v-else v-for="note in note_s" :key="note.id">
                  ...
                  <td><b>{{ note.moduleName }}</b></td>
                  <td><b class="text-success">{{ note.created_at }}</b></td>
                  <td><b class="text-danger">{{ note.updated_at }}</b></td>
                  <td>
                    <button @click="ShowNoteItem(note.id)" class="btn btn-warning" data-toggle="modal" data-target="#modal-info"><i class="fas fa-edit"></i></button>
                    <button @click="ConfirmDelete(note.id)" href="" class="btn btn-danger"><i class="fas fa-times"></i></button>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <form enctype="multipart/form-data" @submit.prevent="UpdateNote">
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ໂມດຸນ: <span class="text-danger">*</span></label>
        ...
        methods:{
            ...
            async ConfirmDelete(Note_ID){
                Swal.fire({
                    ...
                    text: 'ທ່ານແນ່ໃຈບໍ ທີຈະລົບລະຫັດທີ່:'+ Note_ID,
                    icon: 'warning',
